...
export const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      ...
      content: `Working with Vatsal was seamless from day one. Not only did he deliver a full-stack solution ahead of schedule, but he also communicated clearly throughout the project. It's rare to find a developer who understands both the tech and the business side so well.`,
      rating: 5,
    ...
    },
    {
      ...
      content: `From wireframes to deployment, Vatsal owned the entire stack with confidence and creativity. The final product is fast, reliable, and looks incredible. I wouldn't hesitate to work with him again.`,
      rating: 5,
  ...
  return (
    <section
      id="testimonials"
      className="relative py-10 sm:py-14 lg:py-16 px-6 lg:px-6 overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background"
      ref={ref}
    >
