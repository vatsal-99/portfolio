...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at vatsalchandrani99@gmail.com",
        variant: "destructive"
      });
    } finally {
  ...
  return (
    <section id="contact" className="py-10 sm:py-14 md:py-16 px-0 relative bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-secondary/20 to-background border border-border">
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                <div className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-primary/10 text-primary">
                 ...
                 <div className="flex flex-col justify-center text-left">
                  ...
                  <a
                    href="mailto:vatsalchandrani99@gmail.com"
            ...
            <div className="pt-6 sm:pt-8 text-left">
              <h4 className="font-medium mb-3 sm:mb-4 text-xs sm:text-sm text-muted-foreground pl-3">Find me on</h4>
              <div className="flex gap-2 sm:gap-3 text-center">
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/vatsal-chandrani",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/vatsal-99",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
          ...
          <div className="p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-card border border-border shadow-sm">
            ...
            <form className="space-y-4 sm:space-y-6 text-left" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={cn(
                  "w-full flex items-center justify-center gap-2 py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl bg-primary text-primary-foreground font-medium hover:opacity-90 transition-all duration-300 shadow-md text-sm sm:text-base",
